            ...
            <div class="row" style="text-indent: 2em">
                ...
                <div class="col-md-4 tab-bar">
                    <div class="col-md-12 tab-bar">
                        ...
                        <a href="cisp2" class="tab-bar-show">平台特点<i class="fa fa-arrow-circle-right pr-10 colored"></i></a>
                ...
                <div class="col-md-12">
                    <h3 class="about-title mb-30">平台特点</h3>
                    <img src="static/img/cisp1.png" alt="">
                    <img src="static/img/cisp2.png" alt="">
                    <img src="static/img/cisp3.png" alt="">
                    <img src="static/img/cisp4.png" alt="">
                    <img src="static/img/cisp5.png" alt="">
                </div>
            </div>
        </div>
    </section>
