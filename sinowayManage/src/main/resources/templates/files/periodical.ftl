    ...
    <div class="page-header card">
        <div class="card-block">
            <ul class="breadcrumb-title b-t-default p-t-10">
                ...
                <li class="breadcrumb-item"><a href="#!">期刊</a>
                </li>
            </ul>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <div class="card">
                    ...
                    <#--</div>-->
                    <div class="card-block">
                        <form id="periodicalForm" method="post" action="createPeriodical" enctype="multipart/form-data">
                            ...
                            <#--</div>-->
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label" for="pName">期刊名称</label>
                                <div class="col-sm-10">
                                    <input type="text" id="pName" name="pName" class="form-control" placeholder="期刊名称">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">上传期刊</label>
                                <div class="col-sm-10">
...
<script type="text/javascript">
    $('#submit').click(function () {
        $('#periodicalForm').submit();
    })

    $('#periodicalForm').ajaxForm(function(result) {
